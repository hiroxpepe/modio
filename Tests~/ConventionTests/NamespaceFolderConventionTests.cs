...
namespace Modio.Tests.Convention {
    /// <summary>
    /// Verifies that every source file's declared namespace matches its physical
    /// folder, under this repo's source-root convention.
    ///
    /// Convention (root ns = "Modio"):
    ///   ConventionScan.TARGET_DIRS[0]/&lt;A&gt;/&lt;B&gt;/Foo.cs  ->  namespace Modio.&lt;A&gt;.&lt;B&gt;
    ///   - files directly in the source root map to "Modio" itself.
    ...
    public class NamespaceFolderConventionTests
    {
        ...
        static readonly ConventionRule ScriptsRule =
            new(ConventionScan.TARGET_DIRS[0], "Modio", new string[] { });
